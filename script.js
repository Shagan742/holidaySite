...
const vue_app = Vue.createApp({
    ...
    methods: { //does things with data and the math of the computed things
        ...
        spinWheel: function () {
            ...
            const rotation = this.rotateSlice; //this is the rotation of the wheel, it rotates 5 times then stops at a random slice
    ...
    computed: { //does math with the data, returning numbers i can use later 
        rotateSlice: function () {
            if (this.filterItems.length > 0) {
                return 360 / (this.filterItems.length)*5 //it rotates new slices to avoid overlapping
            } else {
